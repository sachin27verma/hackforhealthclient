  ...
  return (
    <div className=" py-4 bg-midnight ">
      <div className=" flex justify-around   gap-3 flex-wrap items-center py-4">
        <div className=" text-white w-full md:w-3/12 border-b-2 py-2 border-white md:border-none text-center md:text-left flex-grow  justify-center items-center flex flex-col  pl-3 gap-2">
        ...
        <div className="md:w-5/12 flex-grow w-full flex border-b-2 py-2 border-white md:border-none flex-col gap-3 justify-center items-center">
          ...
          <p className="text-white font-montserrat text-2xl text-center font-semibold">AI Care,<br className=" block md:hidden">
          </br> Your Wellness Companion. </p>
